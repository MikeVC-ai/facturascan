...
//
// 4. GOOGLE CLOUD VISION Y GEMINI API KEY (OCR HÍBRIDO):
//    Para habilitar el escaneo automático híbrido, genera una API Key
//    en tu proyecto de Google Cloud Console y asegúrate de activar:
//    → Cloud Vision API (para digitalizar la factura con alta precisión)
//    → Generative Language API (para estructurar los campos con Gemini)
//    Esta clave se configura directamente en la pantalla de la app en tu celular.
//
...
// Clave de API de Google Cloud para el OCR de Vision y Gemini.
// Se recomienda dejarla vacía aquí y configurarla en la pantalla de la app.
